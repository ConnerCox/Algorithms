...
Author: Conner Cox
Date: May 15, 2019
Description: shuffles a list of arrays
 */
...
public class Exercise08_37 {
	public static void main(String[] args) {
		...
		//take the 2d array, and make it a list of string arrays
		List<String[]> newList = Arrays.asList(stateCapital);
		//shuffle newList; the original stateCapital 2d array also gets shuffled by reference
