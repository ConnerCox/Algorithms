...
public class Exercise23_03 {
	...
	//partition method used in quicksort recursive method
	...
	//quicksort a list using a comparator
	public static <E> void quickSort(E[] list, Comparator<? super E> comparator) {
		quickSort(list, 0, list.length - 1, comparator);
	}
	
	//quicksort a list using a comparator recursive
	...
	//partition method used in quicksort recursive method with comparator
